...
using namespace illusion::graphics::d3d12::shaders;
...
public:
    ...
    dxc_compiled_shader compile(shader_file_info info, std::filesystem::path full_path, illusion::utl::vector<std::wstring>& extra_args)
    {
    ...
    dxc_compiled_shader compile(IDxcBlobEncoding* source_blob, illusion::utl::vector<std::wstring> compiler_args)
    {
        DxcBuffer buffer{};
