...
{
    if (!illusion::content::load_game()) return false;

    platform::window_init_info info
    {
        &win_proc, nullptr, L"illusion Game" // TODO: get the game name from the loaded game file
    };
