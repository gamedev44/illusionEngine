...
namespace illusionEditor.GameProject
{
    ...
    {
        public static string Extension => ".illusion";
        [DataMember]
        ...
        /// <summary>
        /// Gets the full path of the current illusion project file, including its file name and extension.
        /// </summary>
        public string FullPath => $@"{Path}{Name}{Extension}";
        public string Solution => $@"{Path}{Name}.sln";
        public string ContentPath => $@"{Path}Content\";
        public string TempFolder => $@"{Path}.illusion\Temp\";
